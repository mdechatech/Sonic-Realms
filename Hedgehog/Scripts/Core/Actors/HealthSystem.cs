...
namespace Hedgehog.Core.Actors
{
    ...
    public abstract class HealthSystem : MonoBehaviour
    {
        ...
        public virtual void Start()
        {
            ...
            HurtTriggerHash = string.IsNullOrEmpty(HurtTrigger) ? 0 : Animator.StringToHash(HurtTrigger);
            HurtDamageFloatHash = string.IsNullOrEmpty(HurtDamageFloat) ? 0 : Animator.StringToHash(HurtDamageFloat);
            DeathTriggerHash = string.IsNullOrEmpty(DeathTrigger) ? 0 : Animator.StringToHash(DeathTrigger);
        }
