    ...
    public class LinearItemCarouselArranger : ItemCarouselArranger
    {
        ...
        protected void MoveAll(float smoothSelectedIndex)
        {
            var start = _selectionCenter.position -
                        (Vector3) DMath.UnitVector(_direction*Mathf.Deg2Rad)*_spacing*smoothSelectedIndex;
        ...
        {
            var start = _selectionCenter.position -
                        (Vector3) DMath.UnitVector(_direction*Mathf.Deg2Rad)*_spacing*_smoothSelectedIndex;
