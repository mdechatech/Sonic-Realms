...
namespace SonicRealms.Core.Internal
{
    ...
    public class SrSoundManager : MonoBehaviour
    {
        ...
        public static SrMusicAudioSource PowerupMusicSource { get { return Instance._powerupMusicSource; } }

        public static SrMusicAudioSource MainMusicSource { get { return Instance._mainMusicSource; } }

        private static SrSoundManager Instance
        {
            get
            {
                if (!_instance)
        ...
        private static SrSoundManager _instance;

        private static string PrefabPath = "Sound Manager Prefab";
        private static string MixerPath = "Sound Manager Mixer";

        [SerializeField, HideInInspector]
        private SrMusicAudioSource _mainMusicPrefab;

        [SerializeField, HideInInspector]
        private SrMusicAudioSource _powerupMusicPrefab;
        ...
        private SrMusicAudioSource _mainMusicSource;

        private SrMusicAudioSource _powerupMusicSource;
        ...
        {
            var prefab = Resources.Load<SrSoundManager>(PrefabPath);
            if (!prefab)
            {
        ...
        {
            _mainMusicSource = new GameObject().AddComponent<SrMusicAudioSource>();
            ...
            _powerupMusicSource = new GameObject().AddComponent<SrMusicAudioSource>();
