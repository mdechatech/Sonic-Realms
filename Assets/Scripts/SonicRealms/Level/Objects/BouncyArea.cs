...
{
    /// <summary>
    /// Makes the area bounce players away from it. Very similar code to <see cref="BouncyPlatform"/>, but with
    /// platform-specific stuff omitted.
    /// </summary>
    public class BouncyArea : ReactiveArea
    {
        ...
        /// </summary>
        public BouncyAreaBounceAngleBehavior BounceAngleBehavior
        {
        ...
        /// </summary>
        public BouncyAreaVelocityEffect VelocityEffect
        {
            get { return _velocityEffect; }
            set { _velocityEffect = value; }
        }
        ...
        public override void OnAreaEnter(AreaCollision collision)
        {
            ...
            if (BounceAngleBehavior == BouncyAreaBounceAngleBehavior.UseLineFromCenter)
            {
            ...
            if (VelocityEffect == BouncyAreaVelocityEffect.Set)
            {
                player.Velocity = DMath.UnitVector(normalRadians)*Velocity*velocityMultiplier;
            }
            else if (VelocityEffect == BouncyAreaVelocityEffect.StopAndAdd)
            {
    ...
    /// <summary>
    /// Controls how a <see cref="BouncyArea"/> affects the player's velocity.
    /// </summary>
    public enum BouncyAreaVelocityEffect
    {
        /// <summary>
    ...
    /// <summary>
    /// Controls how a <see cref="BouncyArea"/> decides the angle at which to bounce a player.
    /// </summary>
    public enum BouncyAreaBounceAngleBehavior
    {
        /// <summary>
