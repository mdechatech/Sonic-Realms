...
{
    public class SrLegacyLinearItemCarouselArranger : SrLegacyItemCarouselArranger
    {
        [SerializeField, SrFoldout("Placement")]
        private Transform _itemContainer;

        [SerializeField, SrFoldout("Placement")]
        private Transform _selectionCenter;

        [SerializeField, SrFoldout("Placement"), Range(-180, 180)]
