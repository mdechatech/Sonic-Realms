...
{
    public class SrLegacyFadeToBlackTransition : SrLegacySceneTransition
    {
        ...
        {
            return Camera.allCameras[0].GetComponent<SrBlitMaterial>();
        }
        ...
        {
            var blitMaterial = camera.gameObject.AddComponent<SrBlitMaterial>();
        ...
        {
            if (State == SrLegacyTransitionState.Enter)
            {
            ...
            else if(State == SrLegacyTransitionState.Exit)
            {
