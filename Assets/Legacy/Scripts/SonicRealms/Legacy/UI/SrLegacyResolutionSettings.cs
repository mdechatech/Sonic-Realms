...
{
    [CreateAssetMenu(fileName = "Resolution Settings", menuName = "Sonic Realms/Legacy/Resolution Settings", order = -1)]
    public class SrLegacyResolutionSettings : ScriptableObject
    {
        /// <summary>
        ...
        public class AspectRatio : IEquatable<AspectRatio>
        {
            ...
            {
                var gcd = SrMath.GCD(Horizontal, Vertical);
