...
{
    public class SrLegacyActClearScreen : SrLegacyTransition
    {
        [Space]
        public SrLegacyScoreView TimeBonusView;
        public SrLegacyScoreView RingBonusView;
        public SrLegacyScoreView TotalBonusView;
        ...
        protected SrLegacyGoalLevelManager Level;
        ...
        public override void Enter()
        {
            ...
            Level = SrLegacyGameManager.Instance.Level as SrLegacyGoalLevelManager;
        ...
        {
            if (State != SrLegacyTransitionState.Exit) return;
